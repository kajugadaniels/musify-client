        ...
        <div className="bg-muted/30 flex w-full flex-col border-r lg:w-80">
                                ...
                                <div className="flex gap-2 pb-2">
                                    {styleTags.map((tag) => (
                                        <Badge
                                            variant="secondary"
                                            key={tag}
                                            className="hover:bg-secondary/50 shrink-0 cursor-pointer text-xs"
            ...
            <div className="border-t p-4">
                <Button
                    ...
                    disabled={loading}
                    className="w-full cursor-pointer bg-linear-to-r from-orange-500 to-pink-500 font-medium text-white hover:from-orange-600 hover:to-pink-600"
                >
